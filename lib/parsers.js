...
var daily = ['päevapakkumi', 'täna pakume', 'lõuna']; 

var containsDaily = sentence => {
        ...
        for (line of lines) {
            ...
            try {
                sentences = tokenizer.getSentences().filter(function(e) {
                    return e.length != 0 && (e.match(priceRegex) || containsDaily(e.toLowerCase()));
                }).map(function(e) {
